<template>
	<div class="help informational_page">
		...
		<div class="container">
			<div class="centered_preview">
				...
				<h2>
					We are here to help answer your questions! Please fill out the form below and one our customer service reps will contact you.
				</h2>
			</div>
...
<script>
	...
	import bgLibrary from "~/assets/img/informational-pages/bg-library.jpg";
