	...
	<div class="fieldset_container">
		<div class="form_group">
			...
			<div class="trade_location">
				<label for="switch2">Local trades only?</label>
		...
		<div class="form_group">
			<div class="value">
				...
				<input
					...
					data-vv-scope="OverviewStep"
				>
				<span v-if="errors" class="is_danger error_message">
					{{ errors.first('OverviewStep.price') }}
				</span>
			</div>
			<div class="listing_type">
				...
				/>
				<span v-if="errors" class="is_danger error_message">
					{{ errors.first('OverviewStep.listing_type') }}
				</span>
			</div>
			<div class="trade_type">
				...
				<div class="custom-checkbox">
					<input
						...
						data-vv-scope="OverviewStep"
						v-validate="'required:true'"
						data-vv-name="trade_or_cash"
						data-vv-as="Trade type"
					>
					<label for="barter">
			...
			>{{ errors.first('OverviewStep.trade_or_cash') }}</span>
		</div>
		<div class="form_group">
			...
			<textarea
				...
				data-vv-scope="OverviewStep"
			></textarea>
			<span v-if="errors" class="is_danger error_message">{{ errors.first('OverviewStep.description') }}</span>
		</div>
	</div>
</template>
